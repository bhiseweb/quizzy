...
(function(){
     ...
     */
     ...
     DataService.$inject = ['ArticlesService'];


    function DataService(ArticlesService){
        /*
         ...
         */
         ...
         var correctOp = ArticlesService.query(function(data){
                    
                    
                for(var i = 0; i< data.length; i++){
                 angular.forEach(data[i].correct_answers, function(value) {
                  this.push(value);
                  }, corAns);
                            }
            })
        ...
        var dataObj = {
            ...
            quizQuestions: ArticlesService.query(),
